...
const AllTouristSpots = () => {
  ...
  return (
    <div className="w-[90%] mx-auto md:w-5/6 mt-6 md:mt-10">
      <Helmet>
        <title>Travelors | All Tourist Spots </title>
      </Helmet>
      <div className="flex flex-wrap w-full mb-10 items-center">
        ...
        <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">
          Discover the Worlds Wonders! Browse Through a Collection of Tourist
          Spots Added by Our Global Community of Travel Enthusiasts. Uncover a
          Tapestry of Experiences Waiting to Be Explored. Start Your Journey of
          Discovery Today!.
        </p>
      </div>
